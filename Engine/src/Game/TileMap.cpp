...
TileMap::TileMap(const std::string& fileName)
{
 ...
 m_layers.push_back(new TileLayer(m_tileX,m_tileY,Point(0,0), Dimension(m_tileWidth,m_tileHeight), ImageResourceManager::GetImageResource("Tiles2"), "Collision", 2));
    m_layers.push_back(new TileLayer(m_tileX,m_tileY,Point(0,0), Dimension(m_tileWidth,m_tileHeight), ImageResourceManager::GetImageResource("Tiles"), "Background", 1));
